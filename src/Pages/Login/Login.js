...
const Login = () => {
        ...
        if (error || gError) {
                signInError = <p className='text-red-700 font-bold text-xs'>{error?.message || gError?.message}</p>
        }
                ...
                <section className='mt-20 justify-center flex items-center h-screen'>
                        <div
                                ...
                                <div className="card w-full max-w-5xl">
                                        <h1 className='text-center mt-7 text-2xl font-bold text-pink-700'>LOGIN</h1>
                                        <div className="card-body">
                                                ...
                                                <p className='mt-3'>
                                                        <small className='font-medium'>New to flower-bouquet shop?
                                                                <Link className='text-pink-700 font-extrabold' to="/signup">Create new account
                                                                </Link></small></p>
                                                <div className="divider text-xl font-bold text-pink-900 mt-4">OR</div>
